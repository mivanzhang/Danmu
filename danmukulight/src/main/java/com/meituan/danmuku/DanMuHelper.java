...
import com.meituan.danmuku.model.entity.RichTextParse;
import com.meituan.danmuku.model.utils.DimensionUtil;
import com.meituan.danmuku.view.IDanMuParent;
import com.meituan.danmuku.view.OnDanMuTouchCallBackListener;
...
public final class DanMuHelper {
    ...
    /**
     * 把DanmakuEntity 转换为DanMuModel的对象
     */
        ...
        if (entity.getType() == DanmakuEntity.DANMAKU_TYPE_USERCHAT) {
            ...
            danMuView.setOnTouchCallBackListener(new OnDanMuTouchCallBackListener() {
                ...
                public void callBack(DanMuModel danMuView) {
                    Toast.makeText(mContext,"you have touched the DanMu",Toast.LENGTH_LONG).show();
                }
            });
        } else {
            // 显示的文本内容
